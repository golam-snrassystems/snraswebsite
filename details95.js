    ...
    auth.onAuthStateChanged(async (user) => {
        if (user) {
            ...
            function addItemToTable(normaltime, DO, TDS, PH, TEMPERATURE, ammonia) {
                ...
                var td8 = document.createElement('td') //ammonia
...
async function getAllData() {
    ...
    async function loadData(page) {
        ...
        let fetchData = await fetch("http://34.100.201.70:8345/fetchData95", {
            method: "POST",
...
async function AllDataInCsv() {
    ...
    myToast.show();
    let fetchData2 = await fetch("http://34.100.201.70:8345/fetchAllRecord95", {
        method: "GET",
        // Adding headers to the request
        headers: {
            "Content-type": "application/json; charset=UTF-8"
