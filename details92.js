...
function getGraph() {
    ...
    firebase.database().ref('data/' + 'Y041653632892492').orderByValue().limitToLast(50).on('child_added', (snapshot) => {
...
async function getAllData() {
    ...
    await fetch('http://34.100.201.70:8345/getMaxSize92').then(response => response.json()).then(data => {
    ...
    async function loadData(page) {
        ...
        let fetchData = await fetch("http://34.100.201.70:8345/fetchData92", {
            method: "POST",
...
async function AllDataInCsv() {
    ...
    myToast.show();
    let fetchData2 = await fetch("http://34.100.201.70:8345/fetchAllRecord92", {
        method: "GET",
        // Adding headers to the request
        headers: {
            "Content-type": "application/json; charset=UTF-8"
