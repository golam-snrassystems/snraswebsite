...
//     let buzzerValue = document.getElementById('batteryAlertInput').innerHTML
//     console.log("buzzervalue:", buzzerValue)
...
//     await firebase.database().ref('messages/' + 'Y041653632892485/').set({
//         message: ""
//     })
// }
...
async function getData() {
    ...
    async function keepAlive() {
        ...
        await firebase.database().ref('keepAlive/' + 'Y041653632892486/' + 'online').on('value', (deviceSattus) => {
        ...
        // await firebase.database().ref('motorBatteryDetails/' + 'Y041653632892485/').on('value', (snap) => {
        //     let batteryData = snap.val()
        //     console.log("Battery:", batteryData.motorOnTimeOut)
        //     document.getElementById('batteryAlertInput').innerHTML = `${batteryData.buzzerState}`
        //     document.getElementById('operatingModestate').innerHTML = `${batteryData.operatingPowerSource}`
        //     document.getElementById('pumpState').innerHTML = `Pump ${batteryData.externalPumpState}`
        //     document.getElementById('batteryPercentageState').innerHTML = `${batteryData.batteryPercentage}%`
        //     document.getElementById('motorOnTimeOutState').innerHTML = `${batteryData.motorOnTimeOut} minute`
        //     document.getElementById('motorOnTimeOutStateB').innerHTML = `${batteryData.motorOnTimeOut} minute`
        //     document.getElementById('motorOffTimeOutState').innerHTML = `${batteryData.motorOffTimeOut} minute`
        //     document.getElementById('motorOffTimeOutStateB').innerHTML = `${batteryData.motorOffTimeOut} minute`
        //     document.getElementById('motorStateText').innerHTML = `${batteryData.motorState}`
        //     document.getElementById('batteryAlert').innerHTML = `${batteryData.lowBatteryAlert}`
    ...
    auth.onAuthStateChanged(async (user) => {
        if (user) {
            ...
            // let fetchData1 = await fetch("http://34.100.201.70:8345/getMaxSize86", {
            //     method: "GET",
            //     headers: {
            ...
            firebase.database().ref('data/' + 'Y041653632892486/').orderByValue().limitToLast(50).on('child_added', (snapshot) => {
...
async function getAllData() {
    ...
    await fetch('http://34.100.201.70:8345/getMaxSize86').then(response => response.json()).then(data => {
    ...
    async function loadData(page) {
        ...
        let fetchData = await fetch("http://34.100.201.70:8345/fetchData86", {
            method: "POST",
...
async function AllDataInCsv() {
    ...
    myToast.show();
    let fetchData2 = await fetch("http://34.100.201.70:8345/fetchAllRecord86", {
        method: "GET",
        // Adding headers to the request
        headers: {
            "Content-type": "application/json; charset=UTF-8"
