...
async function getData() {
    ...
    async function keepAlive() {
        ...
        await firebase.database().ref('keepAlive/' + 'Y041653632892485/' + 'online').on('value', (deviceSattus) => {
...
async function getAllData() {
    ...
    await fetch('http://34.100.201.70:8345/getMaxSize85').then(response => response.json()).then(data => {
    ...
    async function loadData(page) {
        ...
        let fetchData = await fetch("http://34.100.201.70:8345/fetchData85", {
            method: "POST",
...
async function AllDataInCsv() {
    ...
    myToast.show();
    let fetchData2 = await fetch("http://34.100.201.70:8345/fetchAllRecord85", {
        method: "GET",
        // Adding headers to the request
        headers: {
            "Content-type": "application/json; charset=UTF-8"
