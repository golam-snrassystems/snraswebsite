...
async function getData() {
    ...
    auth.onAuthStateChanged(async (user) => {
        if (user) {
            ...
            // let fetchData1 = await fetch("http://34.100.201.70:8345/getMaxSize483", {
            //     method: "GET",
            //     headers: {
...
async function getAllData() {
    ...
    await fetch('http://34.100.201.70:8345/getMaxSize483').then(response => response.json()).then(data => {
    ...
    async function loadData(page) {
        ...
        let fetchData = await fetch("http://34.100.201.70:8345/fetchData483", {
            method: "POST",
...
async function AllDataInCsv() {
    ...
    myToast.show();
    let fetchData2 = await fetch("http://34.100.201.70:8345/fetchAllRecord483", {
        method: "GET",
        // Adding headers to the request
        headers: {
            "Content-type": "application/json; charset=UTF-8"
