...
async function getData() {
    ...
    auth.onAuthStateChanged(async (user) => {
        if (user) {
            ...
            // let fetchData1 = await fetch("http://34.100.201.70:8345/getMaxSize487", {
            //     method: "GET",
            //     headers: {
            ...
            firebase.database().ref('data/' + 'Y041653632892487/').orderByValue().limitToLast(50).on('child_added', (snapshot) => {
...
async function getAllData() {
    ...
    await fetch('http://34.100.201.70:8345/getMaxSize487').then(response => response.json()).then(data => {
    ...
    async function loadData(page) {
        ...
        let fetchData = await fetch("http://34.100.201.70:8345/fetchData487", {
            method: "POST",
...
async function AllDataInCsv() {
    ...
    myToast.show();
    let fetchData2 = await fetch("http://34.100.201.70:8345/fetchAllRecord487", {
        method: "GET",
        // Adding headers to the request
        headers: {
            "Content-type": "application/json; charset=UTF-8"
