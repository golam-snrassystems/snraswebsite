...
function updateRotation(command) { firebase.database().ref('messages/' + 'Y041653632892503/').update({ message: command }) }
...
function homePage() { window.location.href = "main503.html" }
