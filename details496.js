...
async function getAllData() {
    ...
    var perPage = 50;
    var totalItems
    await fetch('http://34.100.201.70:8345/getMaxSize496').then(response => response.json()).then(data => {
    ...
    async function loadData(page) {
        ...
        let fetchData = await fetch("http://34.100.201.70:8345/fetchData496", {
            method: "POST",
...
async function AllDataInCsv() {
    ...
    myToast.show();
    let fetchData2 = await fetch("http://34.100.201.70:8345/fetchAllRecord496", {
        method: "GET",
        headers: {
            "Content-type": "application/json; charset=UTF-8"
        }
