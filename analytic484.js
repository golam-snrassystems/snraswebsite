...
function updateRotation(command) {
    ...
    // console.log(command)
    firebase.database().ref('messages/' + 'Y041653632892484/').update({
        message: command
    })
}
...
async function getData(data) {
    ...
    let fetchData = await fetch("http://34.100.201.70:8345/analytics82", {
        method: "POST",
    ...
    console.log("-----resdata------82-----", resdata)
...
function homePage() {
    ...
    window.location.href = "main82.html"
