...
async function getData() {
    ...
    auth.onAuthStateChanged(async (user) => {
        if (user) {
            ...
            // let fetchData1 = await fetch("http://34.100.201.70:8345/getMaxSize93", {
            //     method: "GET",
            //     headers: {
...
async function getAllData() {
    ...
    await fetch('http://34.100.201.70:8345/getMaxSize93').then(response => response.json()).then(data => {
    ...
    async function loadData(page) {
        ...
        let fetchData = await fetch("http://34.100.201.70:8345/fetchData93", {
            method: "POST",
...
async function AllDataInCsv() {
    ...
    myToast.show();
    let fetchData2 = await fetch("http://34.100.201.70:8345/fetchAllRecord93", {
        method: "GET",
        // Adding headers to the request
        headers: {
            "Content-type": "application/json; charset=UTF-8"
